...
if __name__ == "__main__":
    ...
    text = """美国警方称，边界巡防队在德州南部圣安东尼奥市（San Antonio）附近拦下一列有无证移民乘坐的货运列车火车，其中数十人需要就医，两人已经死亡。这起悲剧发生在2022一起更严重的窒息死亡事件现场的附近，当时天气闷热，有53名移民在一次偷渡活动中在一辆拖拉机拖车的后面死亡。德克萨斯州乌弗拉德镇的官员接到了一个匿名紧急电话，告知他们有许多移民在一列火车内呼吸困难。美国国土安全部的调查人员表示，他们现在正在调查人口走私的可能性。
    """
