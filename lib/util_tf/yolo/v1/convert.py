#! /usr/bin/env python
"""
YAD2K weight reader but YAD2K is only for YOLO v2
...
from tensorflow import keras   # Do this
...
if __name__ == '__main__':
    ...
    print(f"../weights exists {os.path.isdir(os.path.join(os.getcwd(), '../weights'))}")
