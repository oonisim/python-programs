...
| %U | Week number of the year (Sunday as the first day of the week) as a zero-padded decimal. | 00, 01, …, 53 |
| %W | Week number of the year (Monday as the first day of the week) as a zero-padded decimal. | 00, 01, …, 53 |
